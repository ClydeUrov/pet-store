...
export const allOrders = [
  {
    ...
    comment:
      "I need to receive my order by January 1st. I need to receive my order by January 1st. I need to receive my order by January 1st.",
  ...
  },
  {
    ...
    paymentMethod: "Credit card",
    comment:
      "I need to receive my order by January 1st. I need to receive my order by January 1st.",
...
const UserOrdersAll = () => {
  return (
    <>
      ...
      <UserOrdersList elements={allOrders} />
    </>
  );
};
