    ...
    <>
      ...
      <div className={css.order_info}>
        <ul className={css.order_list}>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Created at</p>
            <p className={css.order_item_text}>{order.date}</p>
          </li>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Order №</p>
            <p className={css.order_item_text}>{order.orderId}</p>
          </li>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Status</p>
            <p className={css.order_item_text}>{order.status}</p>
          </li>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Comment</p>
            <p className={css.order_item_text}>{order.comment}</p>
          </li>
        </ul>

        <ul className={css.order_list}>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Delivery №</p>
            <p className={css.order_item_text}>{order.ttn}</p>
          </li>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Delivery method</p>
            <p className={css.order_item_text}>{order.deliveryMethod}</p>
          </li>
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Delivery address</p>
            <p className={css.order_item_text}>
              {" "}
          ...
          <li className={css.order_list_item}>
            <p className={css.order_item_title}>Phone number</p>
            <p className={css.order_item_text}>+{order.phone}</p>
          </li>
        </ul>
      </div>
      ...
      <ul className={css.order_all}>
        <li className={css.order_all_item}>
          <p className={css.order_payment_title}>Payment method</p>
          <p className={css.order_payment_text}>{order.paymentMethod}</p>
        </li>
        <li className={css.order_all_item}>
          <p className={css.order_total_title}>Total</p>
          <p className={css.order_total_text}>$70</p>
        </li>
      </ul>
    </>
  );
